        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <CardDescription>
                Daftar semua produk dan jasa di platform
              </CardDescription>
            </div>
          ...
          {showProductFilters && (
            <div className="flex flex-wrap gap-2 pt-2 border-t">
              {(productTypeFilter === "all" ||
                productTypeFilter === "barang") && (
                <Select
                  value={productConditionFilter}
                  onValueChange={(value) => {
                    setProductConditionFilter(value);
                    setProductPage(1);
                  }}
                >
              ...
              <Input
                ...
                onChange={(e) => {
                  setProductPriceMin(e.target.value);
                }}
                className="w-[120px]"
              />
              <Input
                ...
                onChange={(e) => {
                  setProductPriceMax(e.target.value);
                }}
                className="w-[120px]"
              />
              <Input
