...
import { Package, Mail, Phone, MapPin, ShieldCheck } from "lucide-react";
...
export default function Footer({
  ...
  // If we are currently on an admin page, show the compact admin footer look
  if (isAdminPage) {
    return (
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between text-sm text-slate-500">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-slate-400">KampusMarket Admin Panel</span>
            </div>
      ...
      <footer className="bg-slate-900 text-slate-300 mt-auto border-t border-slate-800">
        <div className="container mx-auto px-4 py-12">
                ...
                {isLoggedIn && userRole === "admin" && (
                  <li>
                    <a
                      ...
                      className="text-amber-400 hover:text-amber-300 font-medium transition-colors flex items-center gap-1 pt-1"
                    >
                      <ShieldCheck className="h-4 w-4 text-amber-500" />
                      Panel Admin
                    </a>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>Universitas Brawijaya, Kota Malang, Indonesia</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-400">
            <p>&copy; 2026 KampusMarket. Hak cipta dilindungi.</p>
